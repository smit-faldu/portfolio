...
export default function Experience() {
  return (
    <section className="min-h-screen py-24 px-8 md:px-24 max-w-7xl mx-auto mix-blend-difference w-full relative z-10 flex flex-col justify-center">
      ...
      >
        <h3 className="text-sm font-mono text-white/40 tracking-widest uppercase mb-12">01 / Experience</h3>
        
        <div className="flex flex-col gap-24">
          {resumeData.experience.map((exp, idx) => (
            <div key={idx} className="flex flex-col md:flex-row gap-8 md:gap-32 w-full justify-between items-start border-t border-white/10 pt-10 group">
